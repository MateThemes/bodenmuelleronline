    ...
    <div id="modal-privacy" class="uk-modal-container" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <div class="uk-modal-body" uk-overflow-auto>
                ...
                <h5>Unsere Datenschutzerklärung</h5>
                <p>Hier finden Sie Informationen über den Umgang mit Ihren personenbezogenen Daten beim Besuch
                    unserer
                    Website. Zur
                    Bereitstellung der Funktionen und Dienste unserer Website ist es erforderlich, dass wir
                    personenbezogene Daten über
                    Sie
                    erheben. Nachfolgend erklären wir, welche Daten wir über Sie erheben, wozu dies erforderlich
                    ist,
                    und welche Rechte
                    Sie
                    in Bezug auf Ihre Daten haben.</p>

                <p>Verantwortlich für die Verarbeitung von personenbezogenen Daten auf dieser Website ist (vgl.
                    Impressum):</p>

                <p>Müller Bodenbeläge<br>
                    Wirtstraße 15<br>
                    81539 München</p>

                <p>Tel.: +49 89 295314<br>
                    Mobil: +49 0171 774 32 55<br>
                    Fax: +49 89 222 76 1<br>
                    E-Mail: info[at]boden-mueller.de</p>

                <p>Sie können sich bei Fragen zum Datenschutz auch jederzeit unter info@boden-mueller.de an uns
                    wenden.
                </p>

                <h5>Erhebung und Verarbeitung personenbezogener Daten</h5>

                <p>Sofern auf unseren Websites personenbezogene Daten (z. B. Kontaktformular) abgefragt werden,
                    erfolgt
                    die Preisgabe
                    dieser Daten seitens des Nutzers auf freiwilliger Basis. Diese Daten werden von Müller
                    Bodenbeläge
                    verarbeitet und
                    genutzt, um z. B. Ihre Anfragen zu beantworten oder um Ihnen den Zugang zu speziellen
                    Informationen
                    zu verschaffen.
                </p>

                <p>Wenn Sie sich auf einer unserer Websites bewegen, werden von Ihrem Internetbrowser Daten an
                    unsere
                    Webserver
                    übermittelt.</p>
                ...
                <p>Diese Daten werden in einer Protokolldatei gespeichert. Die Speicherung erfolgt, um die
                    technische
                    Sicherheit unserer
                    Webserver zu gewährleisten, insbesondere zur Abwehr von Angriffen. Die Daten werden in
                    regelmäßigen
                    Abständen
                    automatisch gelöscht.</p>

                <p>Diese Daten sind nicht bestimmten Personen zuordenbar. Eine Zusammenführung dieser Daten mit
                    anderen
                    Datenquellen
                    wird
                    nicht vorgenommen. Wir behalten uns vor, diese Daten nachträglich zu prüfen, wenn uns
                    konkrete
                    Anhaltspunkte für
                    eine
                ...
                <p>Zur Sicherung aller bei uns gespeicherten Daten setzen wir technische Sicherungselemente ein,
                    um Ihre
                    Informationen
                    vor
                    etwaigen Schädigungen, Verlusten und unberechtigten Zugriffen schützen zu können. Die
                    Sicherheitsvorkehrungen werden
                    mit
                    der stetigen technischen Entwicklung regelmäßig aktualisiert und verbessert.</p>
                ...
                <p>Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie
                    können
                    eine bereits
                    erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail
                    an uns.
                    Die
                    Rechtmäßigkeit
                ...
                <p>Im Falle datenschutzrechtlicher Verstöße steht dem Betroffenen ein Beschwerderecht bei der
                    ...
                    Bundeslandes,
                    in dem unser Unternehmen seinen Sitz hat. Eine Liste der Datenschutzbeauftragten sowie deren
                    Kontaktdaten können
                ...
                <p>Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf
                    ...
                    Datenverarbeitung und ggf. ein
                    Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen
                    zum
                    Thema
                    personenbezogene
                ...
                <p>Cookies, die zur Durchführung des elektronischen Kommunikationsvorgangs oder zur
                    ...
                    erwünschter Funktionen erforderlich sind, werden auf Grundlage von Art. 6 Abs. 1 lit. f
                    DSGVO
                    gespeichert. Der
                ...
                <p>Wir verwenden Google Analytics, um die Nutzung unserer Website analysieren und verbessern zu
                    können.
                </p>

                <p>Google Analytics ist ein Webanalysedienst der Google Inc. („Google“). Google Analytics
                    verwendet sog.
                    „Cookies“,
                    ...
                    Internetnutzung
                    verbundene
                    Dienstleistungen gegenüber dem Websitebetreiber zu erbringen. Rechtsgrundlage für die
                    Verarbeitung
                    von Daten mit
                    Hilfe
                    von Google Analytics ist Art. 6 Abs. 1 lit. f DS-GVO. Die im Rahmen von Google Analytics von
                    Ihrem
                    Browser
                    übermittelte
                ...
                <p>Wir verwenden Google Analytics mit der Erweiterung „_anonymizeIp()“. Damit werden die
                    IP-Adressen
                    gekürzt (sog.
                    IP-Masking). Ein Bezug zu bestimmten Personen kann damit ausgeschlossen werden. Google nimmt
                    an dem
                    EU-US Privacy
                    Shield
                    teil, https://www.privacyshield.gov/EU-US-Framework. Damit besteht auch in den
                    Ausnahmefällen, in
                    denen Google
                    personenbezogene Daten in die USA überträgt, ein angemessenes Datenschutzniveau.</p>

                <p>Informationen über Google: Google Dublin, Google Ireland Ltd., Gordon House, Barrow Street,
                    Dublin 4,
                    Ireland,
                    Fax: +353 (1) 436 1001</p>

                <p>Nähere Informationen zu den Nutzungsbedingungen von Google:
                    www.google.com/analytics/terms/de.html
                </p>

                <p>Nähere Informationen zum Datenschutz von Google:
                    www.google.com/intl/de/analytics/privacyoverview.html</p>
                ...
                <p>Die Nutzung von Google Maps erfolgt im Interesse einer ansprechenden Darstellung unserer
                    ...
                    leichten Auffindbarkeit der von uns auf der Website angegebenen Orte. Dies stellt ein
                    berechtigtes
                    Interesse im
                    Sinne
            ...
            <div class="uk-modal-footer uk-text-right">
                <button class="uk-button uk-button-default uk-modal-close" type="button">Fenster
                    schließen</button>
            </div>
